    ...
    <div class="message-container" v-if="loaded">
      <div class="message-incoming message-box">
        ...
        <div class="reader">
          ...
          <div class="reader-box" v-if="loaded">
            ...
            <div class="reader-template" v-if="area.reply_to">
...
const getList = async () => {
  ...
  await apiDataFetch(`/api/messages/`, options.method)
    .then((res) => res.json())
    .then(async (res) => {
      const data = res.data;
...
const favourite = async () => {
  ...
  if (index !== -1) {
    ...
    area.reply_to.prevType = "outgoing"
  }
