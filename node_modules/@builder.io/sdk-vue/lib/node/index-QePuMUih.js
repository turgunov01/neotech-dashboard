...
function _sfc_render$r(e, t, n, o, r, s) {
...
const SHOULD_MENTION_INITIALIZE_SCRIPT = SDK_NAME === "@builder.io/sdk-react-nextjs" || SDK_NAME === "@builder.io/sdk-react", getIvm = () => {
  try {
...
}), BlockStyles = () => import("./block-styles-qwbfY_0r.js").then((e) => e.default).catch((e) => {
  throw console.error(
    "Error while attempting to dynamically import component BlockStyles at ./components/block-styles.vue",
    e
  ), e;
}), BlockWrapper = () => import("./block-wrapper-U7AIQ7GW.js").then((e) => e.default).catch((e) => {
  throw console.error(
    "Error while attempting to dynamically import component BlockWrapper at ./components/block-wrapper.vue",
    e
  ), e;
}), ComponentRef = () => import("./component-ref-91bKp89Q.js").then((e) => e.default).catch((e) => {
  throw console.error(
    "Error while attempting to dynamically import component ComponentRef at ./components/component-ref/component-ref.vue",
    e
  ), e;
}), RepeatedBlock = () => import("./repeated-block-0Y81SWSj.js").then((e) => e.default).catch((e) => {
  throw console.error(
...
const BlocksWrapper = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["render", _sfc_render$o], ["__scopeId", "data-v-a5b13ef9"]]), _sfc_main$p = defineComponent({
  name: "builder-blocks",
...
const Columns = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["render", _sfc_render$l], ["__scopeId", "data-v-27a4dde0"]]), _sfc_main$l = defineComponent({
...
const Image = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$j], ["__scopeId", "data-v-0d528855"]]), _sfc_main$j = defineComponent({
...
function flattenMongoQuery(e, t, n = {}) {
  for (const o in e) {
    ...
    r && typeof r == "object" && !Array.isArray(r) && !Object.keys(r).find((i) => i.startsWith("$")) ? flattenMongoQuery(r, s, n) : n[s] = r;
  }
  return n;
}
...
const SDK_VERSION = "1.1.2", registry = {};
  ...
  methods: {
    ...
    runHttpRequests() {
      ...
      Object.entries(e).forEach(([o, r]) => {
        ...
        fetch$1(s).then((i) => i.json()).then((i) => {
...
export {
  ...
  evaluate as h,
  getStyle as i,
  getClassPropName as j,
  BuilderContext as k,
  Button as l,
  Symbol$1 as m,
  Text as n,
  Blocks as o,
  ContentVariants as p,
  isEditing as q,
  isPreviewing as r,
  createRegisterComponentMessage as s,
  register as t,
  setEditorSettings as u,
  getBuilderSearchParams as v,
